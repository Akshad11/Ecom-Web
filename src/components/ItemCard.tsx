...
export default function ItemCard({ img, discount, pName, pOgPrice, pDisPrice, prating }: MYItemCardData) {
    ...
    return (
        <div className="w-[160px] md:w-[220px] lg:w-[300px] md:h-[300px] h-[200px] lg:h-[400px] rounded-lg shadow-lg">
            <div className='h-[60%] flex justify-center bg-gray-100 items-center relative'>
                ...
                <div className='absolute bg-transparent top-2 right-2 w-7 h-7 md:w-9 md:h-9 lg:w-12 lg:h-12 rounded-full border border-black flex justify-center items-center'>
                    <FontAwesomeIcon className='lg:text-lg' icon={faHeart} />
                </div>
            </div>
